...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-extension-center': { kind: 'none', reason: 'Desktop Profile UI and Host transaction controls; registers nothing model-facing.' },
  ...
  'packages/host/control-protocol': { kind: 'none', reason: 'The local Host control codec registers nothing model-facing.' },
  'packages/host/desktop-host': { kind: 'none', reason: 'The local Desktop Host authority registers nothing model-facing.' },
