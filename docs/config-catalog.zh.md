...
需要：`slarkDevice` · `workspaceRegistry`
...
来源：[`packages/fs/fs-slark-remote/src/index.ts:48`](../packages/fs/fs-slark-remote/src/index.ts)
...
来源：[`packages/host/webserver/src/index.ts:62`](../packages/host/webserver/src/index.ts)
...
来源：[`packages/shell/shell-slark-remote/src/index.ts:44`](../packages/shell/shell-slark-remote/src/index.ts)
...
来源：[`packages/slark/device-client/src/index.ts:67`](../packages/slark/device-client/src/index.ts)
...
需要：`webServer` · `systemPrompt` · `shellEnv`
...
来源：[`packages/slark/local-collaboration/src/index.ts:42`](../packages/slark/local-collaboration/src/index.ts)
...
- `@deepseek-ai/dsh-slark-cloud` — 需要 `webServer`（[`packages/bundle/slark-cloud/src/index.ts`](../packages/bundle/slark-cloud/src/index.ts)）
