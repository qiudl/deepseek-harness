...
- A fresh legacy transfer leaves every provider credential and model route unavailable to both accounts until an explicit claim, while workspace, sessions and non-model settings survive.
