...
| [`fs-slark-remote/`](fs-slark-remote/README.md) | Slark Device Agent `FileSystem` implementation; projects one granted local directory through virtual POSIX paths with no local fallback | (registers `ctx.fs`) |
