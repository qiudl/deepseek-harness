...
export function decodeWindowsHostClientWorkerMessage(
  ...
  if (value.type === 'failed') {
    exactKeys(value, ['version', 'type', 'generation', 'code'])
  ...
  if (value.type === 'stop' || value.type === 'stopped') {
    exactKeys(value, ['version', 'type', 'generation'])
