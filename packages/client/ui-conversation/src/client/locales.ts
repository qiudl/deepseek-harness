...
export const zh = {
  ...
  'attachment.save': '另存附件',
  'attachment.saving': '正在保存…',
  'attachment.saved': '附件已保存',
  'attachment.saveFailed': '保存失败，请重试',
  'attachment.cancelSave': '取消保存',
  'image.pending': '待发送图片',
...
export const en = {
  ...
  'attachment.save': 'Save attachment as',
  'attachment.saving': 'Saving…',
  'attachment.saved': 'Attachment saved',
  'attachment.saveFailed': 'Save failed; try again',
  'attachment.cancelSave': 'Cancel save',
  ...
  'image.resetZoom': 'Fit image to window',
