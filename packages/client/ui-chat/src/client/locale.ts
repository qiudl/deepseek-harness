...
export const zh = {
  ...
  'message.attachment.save': '另存附件 {name}',
  'message.attachment.saving': '正在保存…',
  'message.attachment.saved': '附件已保存',
  'message.attachment.saveFailed': '保存失败，请重试',
  'message.attachment.cancelSave': '取消保存 {name}',
...
export const en = {
  ...
  'message.attachment.save': 'Save attachment {name} as',
  'message.attachment.saving': 'Saving…',
  'message.attachment.saved': 'Attachment saved',
  'message.attachment.saveFailed': 'Save failed; try again',
  'message.attachment.cancelSave': 'Cancel saving {name}',
