...
export const en = {
  ...
  legacyClaimTitle: 'Import previous model setup',
  legacyClaimIntro: 'Review model providers found in an older local DSH installation. Claim each provider for this account separately.',
  legacyClaimInspect: 'Check previous setup',
  legacyClaimEmpty: 'No previous model providers found.',
  legacyClaimModel: 'Model',
  legacyClaimSearch: 'Web search',
  legacyClaimKeyPresent: 'Key available',
  legacyClaimKeyMissing: 'Key missing',
  legacyClaimNoKey: 'No key to claim',
  legacyClaimSharedKey: 'Shared key',
  legacyClaimApply: 'Claim',
  legacyClaimStatus: 'Check status',
  legacyClaimRetry: 'Retry',
  legacyClaimRestore: 'Restore',
  legacyClaimSaved: 'Provider claimed for this account.',
  legacyClaimRestored: 'Previous account setup restored.',
  legacyClaimFailed: 'Model claim failed',
  edit: 'Edit',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  legacyClaimTitle: '导入旧模型配置',
  legacyClaimIntro: '检查本机旧版 DSH 的模型提供方。请为当前账号逐个认领。',
  legacyClaimInspect: '检查旧配置',
  legacyClaimEmpty: '没有找到旧模型提供方。',
  legacyClaimModel: '模型',
  legacyClaimSearch: '网络搜索',
  legacyClaimKeyPresent: '密钥可用',
  legacyClaimKeyMissing: '密钥缺失',
  legacyClaimNoKey: '无可认领密钥',
  legacyClaimSharedKey: '共用密钥',
  legacyClaimApply: '认领',
  legacyClaimStatus: '查看状态',
  legacyClaimRetry: '重试',
  legacyClaimRestore: '恢复',
  legacyClaimSaved: '已为当前账号认领提供方。',
  legacyClaimRestored: '已恢复认领前的账号配置。',
  legacyClaimFailed: '模型认领失败',
  edit: '编辑',
