...
import pluginCatalogRemote from '@deepseek-ai/dsh-host-plugin-catalog-gateway/remote'
...
export type { PluginCatalogEntry, PluginCatalogPage, PluginCatalogQuery } from '@deepseek-ai/dsh-host-plugin-catalog-gateway/types'
export type {} from '@deepseek-ai/dsh-commands/remote'
export type {} from '@deepseek-ai/dsh-file-reference/remote'
export type {} from '@deepseek-ai/dsh-goal/remote'
export type {} from '@deepseek-ai/dsh-host-plugin-inventory/remote'
export type {} from '@deepseek-ai/dsh-host-plugin-catalog-gateway/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      pluginInventoryRemote, pluginCatalogRemote, messageFeedbackRemote, sessionReferencesRemote,
    ]) {
