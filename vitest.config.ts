...
const windowsUnsupportedOwnerTests = process.platform === 'win32'
  ? [
      ...
      'packages/host/desktop-host/tests/model-claim-confirm-authority.spec.ts',
      'packages/host/desktop-host/tests/model-claim-recovery-authority.spec.ts',
...
const windowsRunnerCoverageExclusions = process.platform === 'win32'
  ? [
      ...
      'packages/host/desktop-host/src/legacy-claim-marker.ts',
      'packages/host/desktop-host/src/legacy-claim-recovery-files.ts',
      'packages/host/desktop-host/src/legacy-claim-recovery.ts',
      'packages/host/desktop-host/src/legacy-claim-store.ts',
      'packages/host/desktop-host/src/legacy-claim-target-files.ts',
      ...
      'packages/host/desktop-host/src/private-file-io.ts',
